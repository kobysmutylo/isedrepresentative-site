---
title: ISED Canadian Representative for Japanese Manufacturers
description: How manufacturers in Japan appoint an ISED Canadian Representative: local testing, where the certificate issues, long product lifecycles, documentation and invoicing.
h1: Canadian Representative for manufacturers in Japan
short: Japan
type: country
date: 2026-08-20
updated: 2026-08-26
...
Japanese manufacturers need a Canadian Representative under RSP-100 section 4.1 because the applicant's company address is outside Canada. Testing can be done at an ISED-recognized laboratory in Japan; the certificate is issued by a body on ISED's recognized list, which today means North America, Europe or Singapore. Japanese regulatory teams typically want the full documentation set and a formal invoice before ordering, and want to know that the representative will still be in place for the whole, often very long, life of the product.
</div>

## How certification usually runs from Japan

ISED recognizes wireless device testing laboratories in Japan, so RSS test data can be produced domestically.

The certification decision sits elsewhere. ISED's published list of recognized certification bodies covers bodies in Canada, the United States, Germany, Spain, the United Kingdom, the Netherlands, Austria and Singapore; Japanese-based certification bodies do not currently appear on it. In practice the certificate is issued by the North American CB the manufacturer already uses for its FCC programme, working from the Japanese test data, or by a European body where the EU file is leading. Confirm any proposed CB against ISED's current list by entity name, since some certification groups hold recognition through one national entity and not another.
...
**Group structures.** Where a Japanese group certifies through a US subsidiary, the applicant entity is the one that needs the representative. Tell us which entity will appear on the application before we draft.
...
Shipped from Japan to ISED's laboratory in Canada at the applicant's cost, documented as a regulatory sample; we coordinate and can advise on the Canadian entry. See [ISED audit samples](/guides/ised-audit-samples-who-provides-who-pays/).

<!--faq-->
### Can a Japanese certification body issue our ISED certificate?
...
The appointment can be transferred to another representative and the change notified to ISED through your certification body. This is a question worth asking any prospective representative; see [changing your Canadian Representative](/guides/changing-your-canadian-representative/).

### Do we need a separate letter for each radio in one product?

One letter covers one IC number. A product certified under a single IC number needs one letter regardless of how many radios it contains; separate IC numbers need separate letters.
