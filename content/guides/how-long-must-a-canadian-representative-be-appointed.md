---
title: How Long Must an ISED Canadian Representative Remain Appointed?
description: RSP-100 requires a Canadian Representative for as long as the certified product is offered in Canada. What that means in practice, and how an appointment with no renewal date maps onto it.
h1: How long must a Canadian Representative remain appointed?
...
An appointment is not perpetual — it ends when the obligation does. Under our [terms of service](/terms/) it ends on the earliest of:

- your written confirmation that the product has been permanently withdrawn from the Canadian market;
- 60 days after we send a status enquiry and receive no confirmation that the product is still offered;
- cancellation, surrender or transfer of the certification; or
- withdrawal under the terms, which is limited to unpaid fees, unreachable clients, unanswered ISED enquiries, and cases where continuing would breach our professional obligations.
...
No. A transfer of the certificate to a new holder is a CB process, and the new holder needs its own representative appointment. Our appointment is personal to the applicant named in the order and ends on transfer. See [changing your Canadian Representative](/guides/changing-your-canadian-representative/).
<!--/faq-->
