---
title: ISED Publishes RSS-Gen Issue 6: One-Year Transition Begins
description: ISED published RSS-Gen Issue 6 on July 30, 2026. What changed, how the one-year transition works, and what stays the same for applicants outside Canada.
h1: RSS-Gen Issue 6 is out: what changes and how the transition works
...
The preface to Issue 6 lists the modifications; the ones most likely to matter to applicants and their labs are, in brief: streamlined labelling, including a new QR-code option and permission to put the label in the manual or packaging for very small devices (we cover the labelling changes in detail in [a separate update](/updates/rss-gen-issue-6-labelling-qr-codes/)); clarified electronic-labelling requirements; measurement-equipment calibration requirements and refined procedures for radiated-emissions measurements, with the frequency range for unwanted-emissions measurements extended up to 750 GHz; and the removal of stand-alone receivers from RSS-Gen — they now sit in RSS-310, which was [revised the same day](/updates/rss-310-issue-6-category-ii-receivers/).
...
No. The Canadian Representative requirement comes from RSP-100 section 4.1, not RSS-Gen. Issue 6 changes technical and labelling requirements; the representative requirement, and the attestation letter, are unchanged.

### Can I still file a certification application tested against RSS-Gen Issue 5?
Yes, during the transition period. ISED accepts applications under either Issue 5 or Issue 6 until the transition ends, one year after publication. New test campaigns should target Issue 6.

### Do already-certified products need to be re-certified under Issue 6?
No. The revision applies to certification applications going forward, subject to the transition period. Products already certified and listed in the Radio Equipment List keep their certification.
<!--/faq-->

For the certification process end to end, see the [ISED certification process overview](/guides/ised-certification-process-overview/); for US-certified products entering Canada, see [from FCC to ISED](/guides/fcc-to-ised/).
